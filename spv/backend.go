...
// interface.
func (s *Syncer) LoadTxFilter(ctx context.Context, reload bool, addrs []lddlutil.Address, outpoints []wire.OutPoint) error {
	s.filterMu.Lock()
...
func (s *Syncer) StakeDifficulty(ctx context.Context) (lddlutil.Amount, error) {
