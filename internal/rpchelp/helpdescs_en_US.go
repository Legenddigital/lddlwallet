...
var helpDescsEnUS = map[string]string{
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in Legenddigital",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in Legenddigital",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in Legenddigital",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and Legenddigital amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in Legenddigital",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in Legenddigital",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in Legenddigital",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in Legenddigital",
	...
	"listunspentresult-amount":        "The amount of the output valued in Legenddigital",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in Legenddigital",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in Legenddigital to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in Legenddigital",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in Legenddigital",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in Legenddigital",
	...
	"setticketmaxprice-max":       "The max price (in lddl).",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in Legenddigital",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in Legenddigital.",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in Legenddigital",
