...
This document describes the process of how lddlwallet developers must make
...
- The gRPC `protoc` plugin for Go
  ...
  lddlwallet `vendor` repo to avoid incompatibilities between generated code and
