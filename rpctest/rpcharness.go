...
import (
	...
	rpc "github.com/Legenddigital/lddld/rpcclient"
)
...
// Harness fully encapsulates an active lddld process, along with an embedded
// lddlwallet to provide a unified platform for creating RPC-driven integration
// tests involving lddld. The active lddld node will typically be run in simnet
...
// spends. The active lddld process is fully managed by Harness, which handles
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// Start the lddld node itself. This spawns a new process which will be
	// managed
	...
	// Start lddlwallet. This spawns a new process which will be managed
	...
	// Get a new address from the wallet to be set with lddld's --miningaddr
	time.Sleep(5 * time.Second)
	var miningAddr lddlutil.Address
	for i := 0; i < 100; i++ {
...
// lddld process belonging to this Harness instance. If the initial connection
