// Package rpctest contains tests for lddlwallet's RPC server and a harness used
// to facilitate the tests by setting up a temporary Simnet node and wallet. The
// RPC client implementation in lddlrpcclient is used exclusively to test the RPC
