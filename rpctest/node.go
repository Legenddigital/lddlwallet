...
// nodeConfig contains all the args, and data required to launch a lddld process
...
// command returns the exec.Cmd which will be used to start the lddld process.
...
// to connect to the lddld process that is launched via Start().
...
// as the base for the log and data directories for lddld.
...
// Start creates a new lddld process, and writes its pid in a file reserved for
...
// Stop interrupts the running lddld process, and waits until it exits properly.
