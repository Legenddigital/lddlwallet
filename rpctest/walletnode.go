...
// walletTestConfig contains all the args, and data required to launch a lddlwallet process
...
// command returns the exec.Cmd which will be used to start the lddlwallet
// process.
...
// to connect to the lddlwallet process that is launched via Start().
...
// process, and as the base for the log and data directories for lddlwallet.
...
// Start creates a new lddlwallet process, and writes its pid in a file reserved
...
// Stop interrupts the running lddlwalletTest process process, and waits until it exits
