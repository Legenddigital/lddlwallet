...
import (
	...
	"github.com/Legenddigital/lddlwallet/internal/prompt"
	"github.com/Legenddigital/lddlwallet/internal/zero"
	ldr "github.com/Legenddigital/lddlwallet/loader"
	"github.com/Legenddigital/lddlwallet/p2p"
	"github.com/Legenddigital/lddlwallet/rpc/legacyrpc"
	"github.com/Legenddigital/lddlwallet/rpc/rpcserver"
	"github.com/Legenddigital/lddlwallet/spv"
	"github.com/Legenddigital/lddlwallet/ticketbuyer/v2"
...
func run(ctx context.Context) error {
	...
	// the trusted lddld server.  This blocks until cancelled.
	if !cfg.NoInitialLoad {
		if done(ctx) {
			return ctx.Err()
		}
...
// startChainRPC opens a RPC client connection to a lddld server for blockchain
...
func startChainRPC(ctx context.Context, certs []byte) (*chain.RPCClient, error) {
	...
	rpcc, err := chain.NewRPCClient(activeNet.Params, cfg.RPCConnect,
		cfg.LddldUsername, cfg.LddldPassword, certs, cfg.DisableClientTLS)
	if err != nil {
		return nil, err
	}
