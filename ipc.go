...
// processes to communicate with and and manage the lifetime of a lddld child
...
// message, shutdown begins.  This prevents lddld from continuing to run
...
// for a child lddld process to communicate with a parent process without the
