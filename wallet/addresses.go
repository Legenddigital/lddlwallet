...
func (w *Wallet) nextAddress(op errors.Op, persist persistReturnedChildFunc, account, branch uint32,
	callOpts ...NextAddressCallOption) (lddlutil.Address, error) {
...
func (w *Wallet) watchFutureAddresses(dbtx walletdb.ReadTx) error {
	...
	for account, a := range w.addressBuffers {
		...
		addrs := make([]lddlutil.Address, 0, totalAddrs)
...
func (w *Wallet) NewExternalAddress(account uint32, callOpts ...NextAddressCallOption) (lddlutil.Address, error) {
...
func (w *Wallet) NewInternalAddress(account uint32, callOpts ...NextAddressCallOption) (lddlutil.Address, error) {
	const op errors.Op = "wallet.NewExternalAddress"
	return w.nextAddress(op, w.persistReturnedChild(nil), account, udb.InternalBranch, callOpts...)
}

func (w *Wallet) newChangeAddress(op errors.Op, persist persistReturnedChildFunc, account uint32) (lddlutil.Address, error) {
...
// policy.
func (w *Wallet) NewChangeAddress(account uint32) (lddlutil.Address, error) {
...
func (w *Wallet) AccountBranchAddressRange(account, branch, start, end uint32) ([]lddlutil.Address, error) {
...
func deriveChildAddress(key *hdkeychain.ExtendedKey, child uint32, params *chaincfg.Params) (lddlutil.Address, error) {
...
func appendChildAddrsRange(addrs *[]lddlutil.Address, key *hdkeychain.ExtendedKey,
