...
import (
	...
	hd "github.com/Legenddigital/lddld/hdkeychain"
	...
	"github.com/Legenddigital/lddlwallet/validate"
...
// exists address index of a trusted lddld RPC server.
type existsAddrIndexFinder struct {
	wallet *Wallet
	client *rpc.Client
}

func (f *existsAddrIndexFinder) addressesUsed(addrs []lddlutil.Address) (bitset.Bytes, error) {
	const op errors.Op = "lddld.jsonrpc.existsaddresses"
