...
func NewRescanFilter(addresses []lddlutil.Address, unspentOutPoints []*wire.OutPoint) *RescanFilter {
	filter := &RescanFilter{
		pubKeyHashes:        map[[ripemd160.Size]byte]struct{}{},
		scriptHashes:        map[[ripemd160.Size]byte]struct{}{},
		compressedPubKeys:   map[[33]byte]struct{}{},
...
func (f *RescanFilter) AddAddress(a lddlutil.Address) {
	switch a := a.(type) {
	case *lddlutil.AddressPubKeyHash:
		f.pubKeyHashes[*a.Hash160()] = struct{}{}
	case *lddlutil.AddressScriptHash:
...
func (f *RescanFilter) ExistsAddress(a lddlutil.Address) (ok bool) {
	switch a := a.(type) {
	case *lddlutil.AddressPubKeyHash:
...
func (f *RescanFilter) RemoveAddress(a lddlutil.Address) {
	switch a := a.(type) {
	case *lddlutil.AddressPubKeyHash:
