...
func (w *Wallet) SelectInputs(targetAmount lddlutil.Amount, policy OutputSelectionPolicy) (inputDetail *txauthor.InputDetail, err error) {
...
func (w *Wallet) OutputInfo(out *wire.OutPoint) (OutputInfo, error) {
	...
	err := walletdb.View(w.db, func(dbtx walletdb.ReadTx) error {
		...
		info.Amount = lddlutil.Amount(txDetails.TxRecord.MsgTx.TxOut[out.Index].Value)
