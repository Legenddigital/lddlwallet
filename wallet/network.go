// Copyright (c) 2017-2018 The Legenddigital developers
...
// Peer provides wallets with a subset of Legenddigital network functionality available
// to a single peer.
type Peer interface {
...
// NetworkBackend provides wallets with Legenddigital network functionality.  Some
...
type NetworkBackend interface {
	Peer
	LoadTxFilter(ctx context.Context, reload bool, addrs []lddlutil.Address, outpoints []wire.OutPoint) error
	...
	StakeDifficulty(ctx context.Context) (lddlutil.Amount, error)
}
