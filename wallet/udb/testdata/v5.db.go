...
import (
	...
	"github.com/Legenddigital/lddlutil"
	"github.com/Legenddigital/lddlutil/hdkeychain"
	"github.com/Legenddigital/lddlwallet/wallet/internal/txsizes"
	"github.com/Legenddigital/lddlwallet/wallet/internal/walletdb"
	_ "github.com/Legenddigital/lddlwallet/wallet/internal/walletdb/bdb"
...
func setup() error {
	...
	return walletdb.Update(db, func(dbtx walletdb.ReadWriteTx) error {
		...
		wif, err := lddlutil.NewWIF(privKey, chainParams, chainec.ECTypeSecp256k1)
		if err != nil {
			return err
		}
...
func createUnsignedTicketPurchase(prevOut *wire.OutPoint,
	inputAmount, ticketPrice lddlutil.Amount) (*wire.MsgTx, error) {
	...
	pkScript, err = txscript.GenerateSStxAddrPush(addr,
		lddlutil.Amount(amountsCommitted[0]), ticketFeeLimits)
	if err != nil {
		return nil, err
	}
