...
func StakePoolTicketFee(stakeDiff lddlutil.Amount, relayFee lddlutil.Amount,
	height int32, poolFee float64, params *chaincfg.Params) lddlutil.Amount {
	...
	return lddlutil.Amount(num.Int64())
}
